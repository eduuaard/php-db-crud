      ...
      <div class="container">
        <div class="row">
          <div class="col mt-5 text-center">
            <h1>Bem-vindos ao sistema teste <br> PHP + Banco de dados</h1>
            <br>
            <h4>Informações do sistema:</h4>
            <p>Ao lado esquerdo, tem a <span class="span-home">SIDEBAR</span> a qual tem a home e o <span
                class="span-home">USUÁRIOS</span> que <br> ali estar toda a operação CRUD de usuário. </p>
            <p>Na navbar tem um icon de notificações falando um pouco mais sobre mim.</p>
          </div>
        </div>
      </div>
    </section>
