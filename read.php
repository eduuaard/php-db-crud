...
<head>
    ...
    <title>Usuários - Teste PHP</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="container">
            <h2 class="mt-3">Lista de Usuários</h2>
            <a href="create.php" class="btn btn-success mb-3">Inserir Novo Usuário</a>
            <table class="table">
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td><a href='edit.php?id=" . $row['id'] . "' class='btn btn-warning'>Editar</a> | <a href='delete.php?id=" . $row['id'] . "' class='btn btn-danger'>Excluir</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
